...
Aligned with theta branch asystem/release-v1.5.0-rc2
...
Usage:
  python patch_bailing_hybrid_radix_cache.py
  python patch_bailing_hybrid_radix_cache.py --sglang-path /path/to/sglang
  python patch_bailing_hybrid_radix_cache.py --dry-run
  python patch_bailing_hybrid_radix_cache.py --revert
"""
...
def main():
    ...
    print("=" * 64)
    print("  Bailing Hybrid Radix Cache Patch (rc2-aligned)")
    print("=" * 64)
    ...
    if all_ok:
        if args.dry_run:
            ...
            print("\n  Revert: python patch_bailing_hybrid_radix_cache.py --revert")
    else:
