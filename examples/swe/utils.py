...
@dataclass
class SWEEnvConfig:
    """Environment configuration for AWEAgent-backed SWE-bench training.

    Attributes:
        dataset_path: Path to the SWE-bench JSONL dataset file.
        agent_type: AWEAgent agent type to train, e.g. ``swe`` or ``cc``.
        agent_config: Generic AWEAgent config name. When set, this overrides
        ...
        agent_root: Root directory of the external AWEAgent checkout.
    ...
    agent_type: str = field(
        ...
        metadata={
            "help": (
                "AWEAgent agent type to run. Supported by AWEAgent main: "
    ...
    agent_config: str = field(
        ...
        metadata={
            "help": (
                "Generic AWEAgent YAML config name. When non-empty, overrides "
    ...
    swe_agent_config: str = field(
        ...
        metadata={
            "help": (
                "Name of the AWEAgent YAML config under the external AWEAgent "
    ...
    cc_agent_config: str = field(
        ...
        metadata={
            "help": (
                "Name of the AWEAgent YAML config used when agent_type='cc'. "
    ...
    agent_root: str = field(
        ...
        metadata={
            "help": (
                "Root directory of the external AWEAgent checkout. Defaults to "
                "../AWEAgent relative to the AReaL repository when unset."
            )
        },
    )
